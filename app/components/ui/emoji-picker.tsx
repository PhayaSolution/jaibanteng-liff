...
const EMOJI_DATA: Array<{ emoji: string; keywords: string[] }> = [
  ...
  { emoji: '🥐', keywords: ['croissant', 'bread', 'french', 'bakery', 'food'] },
  { emoji: '🥑', keywords: ['avocado', 'fruit', 'healthy', 'food'] },
  { emoji: '🥒', keywords: ['cucumber', 'vegetable', 'healthy', 'food'] },
  { emoji: '🥓', keywords: ['bacon', 'meat', 'breakfast', 'food'] },
  { emoji: '🥔', keywords: ['potato', 'vegetable', 'food'] },
  { emoji: '🥕', keywords: ['carrot', 'vegetable', 'healthy', 'food'] },
  { emoji: '🌽', keywords: ['corn', 'maize', 'vegetable', 'food'] },
  { emoji: '🌶️', keywords: ['hot', 'pepper', 'spicy', 'food'] },
  { emoji: '🫑', keywords: ['bell', 'pepper', 'vegetable', 'food'] },
  { emoji: '🥬', keywords: ['leafy', 'green', 'vegetable', 'food'] },
  { emoji: '🥦', keywords: ['broccoli', 'vegetable', 'healthy', 'food'] },
  { emoji: '🧄', keywords: ['garlic', 'vegetable', 'food', 'cooking'] },
  { emoji: '🧅', keywords: ['onion', 'vegetable', 'food', 'cooking'] },
  { emoji: '🍄', keywords: ['mushroom', 'vegetable', 'food'] },
  { emoji: '🥜', keywords: ['peanuts', 'nuts', 'snack', 'food'] },
  { emoji: '🌰', keywords: ['chestnut', 'nuts', 'food'] },
  { emoji: '🥖', keywords: ['baguette', 'bread', 'french', 'bakery'] },
  { emoji: '🫓', keywords: ['flatbread', 'bread', 'food'] },
  { emoji: '🥨', keywords: ['pretzel', 'bread', 'snack', 'food'] },
  ...
  { emoji: '🥩', keywords: ['cut', 'meat', 'steak', 'food'] },
  ...
  { emoji: '🧆', keywords: ['falafel', 'middle', 'eastern', 'food'] },
  { emoji: '🥚', keywords: ['egg', 'breakfast', 'food'] },
  { emoji: '🍳', keywords: ['cooking', 'fried', 'egg', 'breakfast', 'food'] },
  { emoji: '🥘', keywords: ['shallow', 'pan', 'food', 'paella'] },
  { emoji: '🍲', keywords: ['pot', 'food', 'stew'] },
  { emoji: '🫕', keywords: ['fondue', 'food', 'cheese'] },
  { emoji: '🥣', keywords: ['bowl', 'spoon', 'food', 'soup'] },
  { emoji: '🥗', keywords: ['green', 'salad', 'healthy', 'food'] },
  { emoji: '🍿', keywords: ['popcorn', 'snack', 'movie', 'food'] },
  ...
  { emoji: '🚗', keywords: ['automobile', 'car', 'vehicle', 'travel', 'transport'] },
  { emoji: '🚕', keywords: ['taxi', 'car', 'vehicle', 'travel', 'transport'] },
  { emoji: '🚙', keywords: ['sport', 'utility', 'vehicle', 'suv', 'car', 'travel'] },
  { emoji: '🚌', keywords: ['bus', 'vehicle', 'public', 'transport', 'travel'] },
  { emoji: '🚎', keywords: ['trolleybus', 'bus', 'public', 'transport', 'travel'] },
  { emoji: '🏎️', keywords: ['racing', 'car', 'sports', 'car', 'vehicle', 'travel'] },
  { emoji: '🚓', keywords: ['police', 'car', 'vehicle', 'police'] },
  { emoji: '🚑', keywords: ['ambulance', 'vehicle', 'medical', 'emergency'] },
  { emoji: '🚒', keywords: ['fire', 'engine', 'truck', 'firefighter', 'emergency'] },
  { emoji: '🚐', keywords: ['minibus', 'van', 'vehicle', 'travel'] },
  { emoji: '🛻', keywords: ['pickup', 'truck', 'vehicle', 'transport'] },
  { emoji: '🚚', keywords: ['delivery', 'truck', 'vehicle', 'transport', 'shipping'] },
  { emoji: '🚛', keywords: ['articulated', 'lorry', 'truck', 'vehicle', 'transport'] },
  { emoji: '🚜', keywords: ['tractor', 'vehicle', 'farm', 'agriculture'] },
  { emoji: '🏍️', keywords: ['motorcycle', 'bike', 'vehicle', 'travel'] },
  { emoji: '🛵', keywords: ['motor', 'scooter', 'vehicle', 'travel'] },
  { emoji: '🦽', keywords: ['manual', 'wheelchair', 'accessibility', 'disability'] },
  { emoji: '🦼', keywords: ['motorized', 'wheelchair', 'accessibility', 'disability'] },
  { emoji: '🛴', keywords: ['scooter', 'vehicle', 'travel'] },
  { emoji: '🚲', keywords: ['bicycle', 'bike', 'vehicle', 'travel', 'exercise'] },
  { emoji: '🛼', keywords: ['roller', 'skate', 'sport', 'vehicle'] },
  { emoji: '🚁', keywords: ['helicopter', 'aircraft', 'vehicle', 'travel'] },
  { emoji: '🛸', keywords: ['flying', 'saucer', 'ufo', 'space', 'alien'] },
  { emoji: '✈️', keywords: ['airplane', 'aircraft', 'flight', 'travel', 'transport'] },
  { emoji: '🛫', keywords: ['airplane', 'departure', 'flight', 'travel'] },
  { emoji: '🛬', keywords: ['airplane', 'arrival', 'flight', 'travel'] },
  { emoji: '🪂', keywords: ['parachute', 'sport', 'sky', 'jump'] },
  { emoji: '💺', keywords: ['seat', 'chair', 'airplane', 'travel'] },
  { emoji: '🚂', keywords: ['locomotive', 'train', 'railway', 'travel', 'transport'] },
  { emoji: '🚃', keywords: ['railway', 'car', 'train', 'travel', 'transport'] },
  { emoji: '🚄', keywords: ['high', 'speed', 'train', 'bullet', 'train', 'travel'] },
  { emoji: '🚅', keywords: ['bullet', 'train', 'high', 'speed', 'travel'] },
  { emoji: '🚆', keywords: ['train', 'railway', 'travel', 'transport'] },
  { emoji: '🚇', keywords: ['metro', 'subway', 'underground', 'travel', 'transport'] },
  { emoji: '🚈', keywords: ['light', 'rail', 'train', 'travel', 'transport'] },
  { emoji: '🚉', keywords: ['station', 'train', 'railway', 'travel'] },
  { emoji: '🚊', keywords: ['tram', 'trolley', 'travel', 'transport'] },
  { emoji: '🚝', keywords: ['monorail', 'train', 'travel', 'transport'] },
  { emoji: '🚞', keywords: ['mountain', 'railway', 'train', 'travel'] },
  { emoji: '🚋', keywords: ['tram', 'car', 'travel', 'transport'] },
  { emoji: '🚍', keywords: ['oncoming', 'bus', 'public', 'transport', 'travel'] },
  { emoji: '🚔', keywords: ['oncoming', 'police', 'car', 'police', 'vehicle'] },
  { emoji: '🚖', keywords: ['oncoming', 'taxi', 'cab', 'vehicle', 'travel'] },
  { emoji: '🚘', keywords: ['oncoming', 'automobile', 'car', 'vehicle', 'travel'] },
  { emoji: '🚢', keywords: ['ship', 'boat', 'water', 'travel', 'transport'] },
  { emoji: '⛴️', keywords: ['ferry', 'boat', 'water', 'travel'] },
  { emoji: '🛳️', keywords: ['passenger', 'ship', 'cruise', 'travel'] },
  { emoji: '⛵', keywords: ['sailboat', 'sailing', 'boat', 'water', 'travel'] },
  { emoji: '🛶', keywords: ['canoe', 'kayak', 'boat', 'water', 'travel'] },
  { emoji: '🚤', keywords: ['speedboat', 'boat', 'water', 'travel'] },
  { emoji: '🛥️', keywords: ['motor', 'boat', 'water', 'travel'] },
  { emoji: '🛟', keywords: ['ring', 'buoy', 'life', 'preserver', 'safety'] },
  { emoji: '⛽', keywords: ['fuel', 'pump', 'gas', 'station', 'car', 'fuel'] },
  { emoji: '🚨', keywords: ['police', 'car', 'light', 'emergency', 'police'] },
  { emoji: '🚥', keywords: ['horizontal', 'traffic', 'light', 'traffic', 'signal'] },
  { emoji: '🚦', keywords: ['vertical', 'traffic', 'light', 'traffic', 'signal'] },
  { emoji: '🛑', keywords: ['stop', 'sign', 'traffic', 'road'] },
  { emoji: '🚧', keywords: ['construction', 'sign', 'road', 'work'] },
  { emoji: '⚓', keywords: ['anchor', 'ship', 'boat', 'maritime'] },
  { emoji: '🎢', keywords: ['roller', 'coaster', 'amusement', 'park', 'entertainment'] },
  { emoji: '🎡', keywords: ['ferris', 'wheel', 'amusement', 'park', 'entertainment'] },
  { emoji: '🎠', keywords: ['carousel', 'horse', 'amusement', 'park', 'entertainment'] },
  { emoji: '🛝', keywords: ['playground', 'slide', 'play', 'children'] },
  { emoji: '🪘', keywords: ['long', 'drum', 'music', 'instrument'] },
  { emoji: '🛍️', keywords: ['shopping', 'bags', 'shopping', 'retail', 'store'] },
  { emoji: '🛒', keywords: ['shopping', 'cart', 'trolley', 'shopping', 'store'] },
  { emoji: '🏪', keywords: ['convenience', 'store', 'shop', 'retail', 'shopping'] },
  ...
  { emoji: '🏯', keywords: ['japanese', 'castle', 'building', 'japan'] },
  { emoji: '🏰', keywords: ['castle', 'building', 'medieval', 'fortress'] },
  { emoji: '💒', keywords: ['wedding', 'marriage', 'ceremony'] },
  { emoji: '🗼', keywords: ['tokyo', 'tower', 'landmark', 'japan'] },
  { emoji: '🗽', keywords: ['statue', 'liberty', 'landmark', 'usa'] },
  ...
  { emoji: '🕍', keywords: ['synagogue', 'building', 'religion', 'judaism'] },
  { emoji: '⛩️', keywords: ['shinto', 'shrine', 'building', 'religion', 'japan'] },
  { emoji: '🕋', keywords: ['kaaba', 'building', 'religion', 'islam'] },
  { emoji: '⛲', keywords: ['fountain', 'water', 'decoration'] },
  { emoji: '⛺', keywords: ['tent', 'camping', 'outdoor'] },
  { emoji: '🌁', keywords: ['foggy', 'weather', 'cloud'] },
  { emoji: '🌃', keywords: ['night', 'stars', 'city', 'skyline'] },
  { emoji: '🏙️', keywords: ['cityscape', 'urban', 'city', 'skyline'] },
  { emoji: '🌄', keywords: ['sunrise', 'over', 'mountains', 'nature', 'landscape'] },
  { emoji: '🌅', keywords: ['sunrise', 'nature', 'landscape', 'morning'] },
  { emoji: '🌆', keywords: ['cityscape', 'dusk', 'evening', 'city'] },
  { emoji: '🌇', keywords: ['sunset', 'cityscape', 'evening', 'city'] },
  { emoji: '🌉', keywords: ['bridge', 'night', 'city', 'landmark'] },
  { emoji: '♨️', keywords: ['hot', 'springs', 'onsen', 'relaxation'] },
  { emoji: '💈', keywords: ['barber', 'pole', 'haircut', 'barbershop'] },
  { emoji: '🏥', keywords: ['hospital', 'medical', 'health', 'building'] },
  { emoji: '🏨', keywords: ['hotel', 'accommodation', 'travel', 'building'] },
  { emoji: '🏩', keywords: ['love', 'hotel', 'accommodation', 'building'] },
  { emoji: '📚', keywords: ['books', 'education', 'reading', 'study'] },
  { emoji: '📖', keywords: ['open', 'book', 'reading', 'education'] },
  { emoji: '📗', keywords: ['green', 'book', 'reading', 'education'] },
  { emoji: '📘', keywords: ['blue', 'book', 'reading', 'education'] },
  { emoji: '📙', keywords: ['orange', 'book', 'reading', 'education'] },
  { emoji: '📕', keywords: ['red', 'book', 'reading', 'education'] },
  { emoji: '📓', keywords: ['notebook', 'writing', 'study', 'education'] },
  { emoji: '📔', keywords: ['notebook', 'decorative', 'cover', 'writing'] },
  { emoji: '📒', keywords: ['ledger', 'notebook', 'accounting', 'office'] },
  { emoji: '📃', keywords: ['page', 'curl', 'document', 'office'] },
  { emoji: '📜', keywords: ['scroll', 'document', 'ancient', 'office'] },
  { emoji: '📄', keywords: ['page', 'facing', 'up', 'document', 'office'] },
  { emoji: '📑', keywords: ['bookmark', 'tabs', 'document', 'office'] },
  { emoji: '📊', keywords: ['bar', 'chart', 'graph', 'data', 'office'] },
  { emoji: '📈', keywords: ['chart', 'increasing', 'graph', 'data', 'office'] },
  { emoji: '📉', keywords: ['chart', 'decreasing', 'graph', 'data', 'office'] },
  { emoji: '🗃️', keywords: ['card', 'file', 'box', 'office', 'organization'] },
  { emoji: '🗄️', keywords: ['file', 'cabinet', 'office', 'organization'] },
  { emoji: '🗂️', keywords: ['card', 'index', 'dividers', 'office', 'organization'] },
  { emoji: '📁', keywords: ['file', 'folder', 'office', 'organization'] },
  { emoji: '📂', keywords: ['open', 'file', 'folder', 'office', 'organization'] },
  { emoji: '📋', keywords: ['clipboard', 'office', 'organization'] },
  { emoji: '📌', keywords: ['pushpin', 'pin', 'office', 'organization'] },
  { emoji: '📍', keywords: ['round', 'pushpin', 'pin', 'location', 'office'] },
  { emoji: '📎', keywords: ['paperclip', 'office', 'attachment'] },
  { emoji: '🖇️', keywords: ['linked', 'paperclips', 'office', 'attachment'] },
  { emoji: '📏', keywords: ['straight', 'ruler', 'measurement', 'office'] },
  { emoji: '📐', keywords: ['triangular', 'ruler', 'measurement', 'office'] },
  { emoji: '✂️', keywords: ['scissors', 'cut', 'office', 'tool'] },
  { emoji: '🗑️', keywords: ['wastebasket', 'trash', 'office'] },
  { emoji: '🔒', keywords: ['locked', 'lock', 'security', 'privacy'] },
  { emoji: '🔓', keywords: ['unlocked', 'lock', 'security', 'open'] },
  { emoji: '🔏', keywords: ['locked', 'ink', 'pen', 'security', 'privacy'] },
  { emoji: '🔐', keywords: ['locked', 'key', 'security', 'privacy'] },
  { emoji: '🔑', keywords: ['key', 'lock', 'security', 'access'] },
  { emoji: '🗝️', keywords: ['old', 'key', 'lock', 'security'] },
  { emoji: '⛏️', keywords: ['pick', 'tool', 'mining'] },
  { emoji: '🗡️', keywords: ['dagger', 'knife', 'weapon'] },
  { emoji: '⚔️', keywords: ['crossed', 'swords', 'weapon', 'battle'] },
  { emoji: '🔫', keywords: ['water', 'pistol', 'gun', 'toy'] },
  { emoji: '🪃', keywords: ['boomerang', 'weapon', 'australia'] },
  { emoji: '🛡️', keywords: ['shield', 'protection', 'defense'] },
  { emoji: '🦯', keywords: ['probing', 'cane', 'accessibility', 'blind'] },
  { emoji: '🩹', keywords: ['adhesive', 'bandage', 'medical', 'health'] },
  { emoji: '🩺', keywords: ['stethoscope', 'medical', 'health', 'doctor'] },
  { emoji: '💊', keywords: ['pill', 'medicine', 'medical', 'health'] },
  { emoji: '💉', keywords: ['syringe', 'medicine', 'medical', 'health'] },
  { emoji: '🩸', keywords: ['drop', 'blood', 'medical', 'health'] },
  { emoji: '🧬', keywords: ['dna', 'science', 'biology', 'genetics'] },
  { emoji: '🦠', keywords: ['microbe', 'bacteria', 'virus', 'science'] },
  { emoji: '🧫', keywords: ['petri', 'dish', 'science', 'biology'] },
  { emoji: '🧪', keywords: ['test', 'tube', 'science', 'chemistry'] },
  { emoji: '🌡️', keywords: ['thermometer', 'temperature', 'weather', 'medical'] },
  { emoji: '🧹', keywords: ['broom', 'cleaning', 'household'] },
  { emoji: '🧺', keywords: ['basket', 'laundry', 'household'] },
  { emoji: '🧻', keywords: ['roll', 'toilet', 'paper', 'bathroom', 'household'] },
  { emoji: '🪣', keywords: ['bucket', 'cleaning', 'household'] },
  { emoji: '🧼', keywords: ['soap', 'cleaning', 'bathroom', 'household'] },
  { emoji: '🪥', keywords: ['toothbrush', 'dental', 'hygiene', 'household'] },
  { emoji: '🪒', keywords: ['razor', 'shaving', 'grooming'] },
  { emoji: '🧽', keywords: ['sponge', 'cleaning', 'household'] },
  ...
  { emoji: '🦁', keywords: ['lion', 'face', 'animal'] },
  ...
  { emoji: '🙈', keywords: ['see', 'no', 'evil', 'monkey', 'animal'] },
  { emoji: '🙉', keywords: ['hear', 'no', 'evil', 'monkey', 'animal'] },
  { emoji: '🙊', keywords: ['speak', 'no', 'evil', 'monkey', 'animal'] },
  { emoji: '🐒', keywords: ['monkey', 'animal'] },
  { emoji: '🐔', keywords: ['chicken', 'animal', 'farm'] },
  ...
  { emoji: '🐥', keywords: ['front', 'facing', 'baby', 'chick', 'animal'] },
  { emoji: '🦆', keywords: ['duck', 'animal', 'bird'] },
  { emoji: '🦅', keywords: ['eagle', 'animal', 'bird'] },
  { emoji: '🦉', keywords: ['owl', 'animal', 'bird'] },
  ...
  { emoji: '🦄', keywords: ['unicorn', 'face', 'animal', 'fantasy'] },
  { emoji: '🐝', keywords: ['honeybee', 'bee', 'insect', 'animal'] },
  { emoji: '🐛', keywords: ['bug', 'insect', 'animal'] },
  { emoji: '🦋', keywords: ['butterfly', 'insect', 'animal'] },
  { emoji: '🐌', keywords: ['snail', 'animal', 'slow'] },
  { emoji: '🐞', keywords: ['lady', 'beetle', 'insect', 'animal'] },
  { emoji: '🐜', keywords: ['ant', 'insect', 'animal'] },
  { emoji: '🪲', keywords: ['beetle', 'insect', 'animal'] },
  { emoji: '🪳', keywords: ['cockroach', 'insect', 'animal'] },
  { emoji: '🕷️', keywords: ['spider', 'insect', 'animal'] },
  { emoji: '🕸️', keywords: ['spider', 'web', 'insect', 'animal'] },
  { emoji: '🦂', keywords: ['scorpion', 'insect', 'animal'] },
  { emoji: '🦟', keywords: ['mosquito', 'insect', 'animal'] },
  { emoji: '🪰', keywords: ['fly', 'insect', 'animal'] },
  { emoji: '🪱', keywords: ['worm', 'insect', 'animal'] },
  { emoji: '💐', keywords: ['bouquet', 'flowers', 'nature'] },
  { emoji: '🌸', keywords: ['cherry', 'blossom', 'flower', 'nature', 'spring'] },
  { emoji: '💮', keywords: ['white', 'flower', 'nature'] },
  { emoji: '🌹', keywords: ['rose', 'flower', 'nature', 'romance'] },
  { emoji: '🥀', keywords: ['wilted', 'flower', 'nature'] },
  { emoji: '🌺', keywords: ['hibiscus', 'flower', 'nature'] },
  { emoji: '🌻', keywords: ['sunflower', 'flower', 'nature'] },
  { emoji: '🌼', keywords: ['blossom', 'flower', 'nature'] },
  { emoji: '🌷', keywords: ['tulip', 'flower', 'nature', 'spring'] },
  { emoji: '🌱', keywords: ['seedling', 'plant', 'nature', 'growth'] },
  { emoji: '🪴', keywords: ['potted', 'plant', 'nature', 'houseplant'] },
  { emoji: '🌲', keywords: ['evergreen', 'tree', 'nature', 'christmas'] },
  { emoji: '🌳', keywords: ['deciduous', 'tree', 'nature'] },
  { emoji: '🌴', keywords: ['palm', 'tree', 'nature', 'tropical'] },
  { emoji: '🌵', keywords: ['cactus', 'plant', 'nature', 'desert'] },
  { emoji: '🌾', keywords: ['sheaf', 'rice', 'plant', 'nature', 'agriculture'] },
  { emoji: '🌿', keywords: ['herb', 'plant', 'nature'] },
  { emoji: '☘️', keywords: ['shamrock', 'plant', 'nature', 'ireland'] },
  { emoji: '🍀', keywords: ['four', 'leaf', 'clover', 'plant', 'nature', 'luck'] },
  { emoji: '🍁', keywords: ['maple', 'leaf', 'nature', 'autumn', 'canada'] },
  { emoji: '🍂', keywords: ['fallen', 'leaf', 'nature', 'autumn'] },
  { emoji: '🍃', keywords: ['leaf', 'fluttering', 'wind', 'nature'] },
  { emoji: '🍇', keywords: ['grapes', 'fruit', 'food', 'nature'] },
  { emoji: '🍈', keywords: ['melon', 'fruit', 'food', 'nature'] },
  { emoji: '🍉', keywords: ['watermelon', 'fruit', 'food', 'nature'] },
  { emoji: '🍊', keywords: ['tangerine', 'orange', 'fruit', 'food', 'nature'] },
  { emoji: '🍋', keywords: ['lemon', 'fruit', 'food', 'nature'] },
  { emoji: '🍌', keywords: ['banana', 'fruit', 'food', 'nature'] },
  { emoji: '🍍', keywords: ['pineapple', 'fruit', 'food', 'nature'] },
  { emoji: '🥭', keywords: ['mango', 'fruit', 'food', 'nature'] },
  { emoji: '🍎', keywords: ['red', 'apple', 'fruit', 'food', 'nature'] },
  { emoji: '🍏', keywords: ['green', 'apple', 'fruit', 'food', 'nature'] },
  { emoji: '🍐', keywords: ['pear', 'fruit', 'food', 'nature'] },
  { emoji: '🍑', keywords: ['peach', 'fruit', 'food', 'nature'] },
  { emoji: '🍒', keywords: ['cherries', 'fruit', 'food', 'nature'] },
  { emoji: '🍓', keywords: ['strawberry', 'fruit', 'food', 'nature'] },
  { emoji: '🫐', keywords: ['blueberries', 'fruit', 'food', 'nature'] },
  { emoji: '🥝', keywords: ['kiwi', 'fruit', 'food', 'nature'] },
  { emoji: '🍅', keywords: ['tomato', 'fruit', 'food', 'nature'] },
  { emoji: '🫒', keywords: ['olive', 'fruit', 'food', 'nature'] },
  { emoji: '🥥', keywords: ['coconut', 'fruit', 'food', 'nature'] },
  { emoji: '🍆', keywords: ['eggplant', 'vegetable', 'food', 'nature'] },
];
...
const EMOJI_CATEGORIES = [
  {
    name: 'Food & Drinks',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['food', 'drink', 'eat', 'coffee', 'pizza', 'burger', 'cake', 'fruit', 'vegetable', 'meat', 'bread', 'dessert', 'alcohol', 'tea', 'juice', 'snack', 'breakfast', 'lunch', 'dinner', 'seafood', 'bakery', 'restaurant', 'cooking', 'dining'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Travel & Transport',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['travel', 'transport', 'car', 'bus', 'train', 'airplane', 'flight', 'vehicle', 'taxi', 'bike', 'motorcycle', 'ship', 'boat', 'helicopter', 'subway', 'metro', 'station', 'fuel', 'gas', 'road', 'traffic', 'hotel', 'accommodation', 'cruise', 'ferry', 'sailing', 'scooter', 'wheelchair'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Shopping & Retail',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['shopping', 'retail', 'store', 'shop', 'cart', 'trolley', 'bags', 'department', 'convenience', 'market', 'mall'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Health & Medical',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['medical', 'health', 'hospital', 'doctor', 'medicine', 'pill', 'syringe', 'stethoscope', 'bandage', 'blood', 'dna', 'microbe', 'bacteria', 'virus', 'science', 'biology', 'thermometer', 'fever', 'sick', 'ill', 'emergency', 'ambulance', 'fitness', 'gym', 'exercise', 'yoga', 'meditation'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Education & Office',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['education', 'school', 'office', 'book', 'reading', 'study', 'writing', 'document', 'folder', 'file', 'notebook', 'pen', 'pencil', 'paper', 'clipboard', 'paperclip', 'ruler', 'scissors', 'calculator', 'computer', 'laptop', 'keyboard', 'printer', 'desk', 'chair', 'meeting', 'presentation'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Home & Household',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['home', 'household', 'house', 'building', 'room', 'furniture', 'bed', 'sofa', 'chair', 'table', 'lamp', 'light', 'cleaning', 'broom', 'basket', 'soap', 'toothbrush', 'razor', 'sponge', 'bucket', 'toilet', 'bathroom', 'kitchen', 'cooking', 'appliance'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Entertainment',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['entertainment', 'movie', 'film', 'cinema', 'music', 'sing', 'karaoke', 'game', 'gaming', 'play', 'theater', 'drama', 'circus', 'amusement', 'park', 'roller', 'coaster', 'ferris', 'wheel', 'carousel', 'party', 'celebration', 'festival', 'concert', 'show', 'performance'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Activities & Sports',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['sport', 'sports', 'activity', 'activities', 'exercise', 'fitness', 'gym', 'running', 'swimming', 'cycling', 'biking', 'hiking', 'climbing', 'surfing', 'skiing', 'snowboarding', 'golf', 'tennis', 'basketball', 'football', 'soccer', 'baseball', 'volleyball', 'badminton', 'boxing', 'martial', 'arts', 'yoga', 'meditation', 'dance', 'ballet'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Animals & Nature',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['animal', 'animals', 'pet', 'dog', 'cat', 'bird', 'fish', 'nature', 'plant', 'tree', 'flower', 'leaf', 'grass', 'forest', 'mountain', 'ocean', 'sea', 'beach', 'sun', 'moon', 'star', 'sky', 'cloud', 'rain', 'snow', 'wind', 'weather', 'landscape', 'garden', 'park'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Objects & Tools',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['object', 'objects', 'tool', 'tools', 'phone', 'mobile', 'smartphone', 'camera', 'photo', 'photography', 'watch', 'clock', 'time', 'alarm', 'battery', 'power', 'energy', 'charge', 'light', 'bulb', 'flashlight', 'candle', 'fire', 'water', 'money', 'dollar', 'banknote', 'credit', 'card', 'payment', 'wallet', 'coin', 'cash', 'gem', 'diamond', 'jewelry', 'precious', 'repair', 'fix', 'build', 'construction', 'hammer', 'wrench', 'screwdriver', 'saw', 'axe'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Faces & Emotions',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['face', 'faces', 'smile', 'happy', 'sad', 'angry', 'cry', 'laugh', 'emotion', 'emotions', 'feeling', 'feelings', 'grinning', 'winking', 'kissing', 'love', 'romance', 'excited', 'surprised', 'shocked', 'scared', 'afraid', 'fear', 'tired', 'sleepy', 'sick', 'ill', 'relief', 'peaceful', 'proud', 'confused', 'worried', 'anxious', 'disappointed', 'frustrated', 'embarrassed', 'blush'].includes(k))).map(e => e.emoji),
  },
  {
    name: 'Symbols & Signs',
    emojis: EMOJI_DATA.filter(e => e.keywords.some(k => ['symbol', 'symbols', 'sign', 'signs', 'heart', 'love', 'romance', 'religion', 'christian', 'islam', 'muslim', 'judaism', 'jewish', 'buddhism', 'hindu', 'spiritual', 'zodiac', 'astrology', 'peace', 'peaceful', 'cross', 'star', 'crescent', 'yin', 'yang', 'balance', 'philosophy', 'prayer', 'worship', 'danger', 'warning', 'toxic', 'radioactive', 'biohazard', 'nuclear', 'acceptable', 'ok', 'id', 'identity', 'atom', 'science', 'physics'].includes(k))).map(e => e.emoji),
  },
];
